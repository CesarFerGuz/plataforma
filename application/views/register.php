...
<head>
  ...
  <link href="<?php echo base_url(); ?>assets/img/apple-touch-icon.svg" rel="apple-touch-icon">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method= "post" action= "<?php echo base_url(); ?>register/validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Por favor introduce un correo valido!</div>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="register">Registrarse</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">¿Tines una cuenta? <a href="<?php echo base_url(); ?>login">Inicia sesión</a></p>
                    </div>
                  </form>
